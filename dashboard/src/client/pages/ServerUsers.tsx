...
const ServerUsers: React.FC = () => {
    ...
    const handleDeleteServerData = async () => {
        if (!window.confirm('Are you sure you want to delete ALL data for this server? This includes all users, stocks, and portfolios. This action CANNOT be undone.')) {
            return;
        }
        ...
        try {
            ...
            console.error(err);
            alert('An error occurred while deleting server data.');
        }
    };
